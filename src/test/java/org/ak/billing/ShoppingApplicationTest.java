...
public class ShoppingApplicationTest {
        ...
        public void UserHasGoldCart() throws InventoryShortageException {
                ...
                UserDetails userDetails = new UserDetails.Builder()
                                .name("Umut Cahan")
                                .userType(UserTypes.GOLD_CART)
                                .userSince(localDateTime)
                                .contacts("+90-565-000-01", "umut@gmail.com")
                                .build();
        ...
        public void UserHasSılverCart() throws InventoryShortageException {
                ...
                UserDetails userDetails = new UserDetails.Builder()
                                .name("Ali Filiz")
                                .userType(UserTypes.SILVER_CART)
                                .userSince(localDateTime)
                                .contacts("+90-532-000-01", "ali@gmail.com")
                                .build();
        ...
        public void UserIsRecentCustomer() throws InventoryShortageException {
                ...
                UserDetails userDetails = new UserDetails.Builder()
                                ...
                                .userSince(localDateTime)
                                .contacts("+90-565-000-41", "ahmet@gmail.com")
                                .build();
        ...
        public void UserIsOldCustomer() throws InventoryShortageException {
                ...
                UserDetails userDetails = new UserDetails.Builder()
                                .name("Mehmet Cetinkaya")
                                .userType(UserTypes.CUSTOMER)
                                .userSince(localDateTime)
                                .contacts("+90-565-000-001", "mehmet@gmail.com")
                                .build();
